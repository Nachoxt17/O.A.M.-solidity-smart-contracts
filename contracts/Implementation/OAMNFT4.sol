...
contract OAMNFT4 is ERC721Enumerable, ERC20, IOAMNFT {
    using Strings for uint256;

    //+-N.F.T. Parameters:_
    address public artWorkOwner; //(Here you need to Set the Real ArtWork Owner Wallet Address).
    string public artWorkName = "Artwork 2022 04";
    string public artWorkSymbol = "OAM2204";
    uint256 public artWorkId = 4; //+-INSTERT TOKEN I.D. Number HERE.
    string public baseURI = "https://openartmarket.com/contract/OAM2204";
    string public baseExtension = ".json";

    string public artShareName = "OAM 2022 04";
    string public artShareSymbol = "OAM2204";
